...
|---|---|---|---|---|---|
| `verify-invasion` | 45 | 2026-08-04 14:35:38 | `F5E5985B…9BB1E1` | 249,506 B | `origin/main`(`33c1681`) 번들과 **바이트 동일 확인**(download 재대조) · 해저드 반감(PR#292) |
| `verify-commission` | 10 | 2026-08-04 14:35:53 | `097A962B…777781` | 244,840 B | `origin/main`(`33c1681`) 번들과 **바이트 동일 확인**(download 재대조) · 해저드 반감(PR#292) |
