...
-- =============================================================================
-- ⚠️ 배포 상태: **원격 미적용**(2026-07-23 작성 시점). 리포 커밋만 된 상태다.
--    선행 5종(20260721000000·20260721010000·20260722000000·20260722010000·
--    20260722020000)이 원격에 적용된 **뒤**에 적용해야 한다. 이 파일은 그 5종이
--    만든 스키마(invasion_socket_count / invasion_layers_valid)를 전제한다.
--
