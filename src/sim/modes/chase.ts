 ...
 */
export const CHASE_COUNTER_DEVICE_HP_BASE = 52000;
 ...
 * | 보스도달 | 82.6s | **64.8s** |
 *
 * ⚠️ 오염과 같은 페이싱·난이도 결합이 여기에도 있다({@link CHASE_COUNTER_DEVICE_HP_BASE} 를
 * 낮추면 취약화가 빨라져 보스 도달이 함께 당겨진다). 밸런스 큐 §R11 참조.
 */
