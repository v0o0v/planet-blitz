...
/** {@link import('../catalystHooks.js').onDamageChainCatalyst} 의 kras 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyDamagedCatalyst} 의 kras 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLootRollCatalyst} 의 kras 몫. **미배선**(위 §주석). */
