...
/** {@link import('../catalystHooks.js').onPlayerDamagedCatalyst} 의 drops 몫. **미배선**(위 §주석). */
export function dropsOnPlayerDamaged(state: WorldState, player: Entity, dmg: number, lethalSurvived: boolean, sources: DamageSourceMask): void {
  void state;
  void player;
  void dmg;
  void lethalSurvived;
...
/** {@link import('../catalystHooks.js').onEnemyDamagedCatalyst} 의 drops 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyDeathCatalyst} 의 drops 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLevelUpCatalyst} 의 drops 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLootRollCatalyst} 의 drops 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLootCollectedCatalyst} 의 drops 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyContactCatalyst} 의 drops 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyStepCatalyst} 의 drops 몫. **미배선**(위 §주석). */
