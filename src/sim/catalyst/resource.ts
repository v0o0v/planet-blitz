...
/** {@link import('../catalystHooks.js').onKillsDeltaCatalyst} 의 resource 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyDamagedCatalyst} 의 resource 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyDeathCatalyst} 의 resource 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onPowerupOfferCatalyst} 의 resource 몫. **미배선**(위 §주석). */
export function resourceOnPowerupOffer(state: WorldState, offers: number[]): void {
  void state;
  void offers;
}

/** {@link import('../catalystHooks.js').onPowerupPickedCatalyst} 의 resource 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onResourceGrantedCatalyst} 의 resource 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLootCollectedCatalyst} 의 resource 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyStepCatalyst} 의 resource 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onDestructibleDestroyedCatalyst} 의 resource 몫. **미배선**(위 §주석). */
