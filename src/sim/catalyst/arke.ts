/**
 * 촉매 **아르케 특산**(id 39~41) — 카드 본체가 들어갈 자리.
 *
 * ## 왜 그룹마다 파일을 가르는가
...
/** {@link import('../catalystHooks.js').onPlayerDamagedCatalyst} 의 arke 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onWallContactCatalyst} 의 arke 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLootRollCatalyst} 의 arke 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLootCollectedCatalyst} 의 arke 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onWaveAdvancedCatalyst} 의 arke 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onDestructibleDestroyedCatalyst} 의 arke 몫. **미배선**(위 §주석). */
