/**
 * 촉매 **니플헤임 특산**(id 36~38) — 카드 본체가 들어갈 자리.
 *
 * ## 왜 그룹마다 파일을 가르는가
...
/** {@link import('../catalystHooks.js').onLootRollCatalyst} 의 niflheim 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyContactCatalyst} 의 niflheim 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyStepCatalyst} 의 niflheim 몫. **미배선**(위 §주석). */
