/**
 * 촉매 **출력 축**(id 25~29) — 카드 본체가 들어갈 자리.
 *
 * ## 왜 그룹마다 파일을 가르는가
...
/** {@link import('../catalystHooks.js').onVolleyFiredCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnVolleyFired(state: WorldState, player: Entity): void {
  void state;
  void player;
}

/** {@link import('../catalystHooks.js').onDashFiredCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnDashFired(state: WorldState, player: Entity): void {
  void state;
  void player;
}

/** {@link import('../catalystHooks.js').onGemCollectedCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnGemCollected(state: WorldState, gem: Entity): void {
  void state;
  void gem;
}

/** {@link import('../catalystHooks.js').onPlayerDamagedCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnPlayerDamaged(state: WorldState, player: Entity, dmg: number, lethalSurvived: boolean, sources: DamageSourceMask): void {
  void state;
  void player;
  void dmg;
  void lethalSurvived;
...
/** {@link import('../catalystHooks.js').onKillsDeltaCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnKillsDelta(state: WorldState, delta: number): void {
  void state;
  void delta;
}

/** {@link import('../catalystHooks.js').onBulletExpiredCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnBulletExpired(state: WorldState, bullet: Entity, reason: BulletExpiryReason): void {
  void state;
  void bullet;
  void reason;
}

/** {@link import('../catalystHooks.js').onWallContactCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnWallContact(state: WorldState, player: Entity): void {
  void state;
  void player;
}

/** {@link import('../catalystHooks.js').onDamageChainCatalyst} 의 power 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyDamagedCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnEnemyDamaged(state: WorldState, target: Entity, dmg: number, source: Entity | undefined): void {
  void state;
  void target;
  void dmg;
  void source;
...
/** {@link import('../catalystHooks.js').onEnemyDeathCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnEnemyDeath(state: WorldState, x: number, y: number, elite: boolean): void {
  void state;
  void x;
  void y;
  void elite;
...
/** {@link import('../catalystHooks.js').onLevelUpCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnLevelUp(state: WorldState, level: number): void {
  void state;
  void level;
}

/** {@link import('../catalystHooks.js').onPowerupOfferCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnPowerupOffer(state: WorldState, offers: number[]): void {
  void state;
  void offers;
}

/** {@link import('../catalystHooks.js').onPowerupPickedCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnPowerupPicked(state: WorldState, poolIndex: number, offeredIndex: number): void {
  void state;
  void poolIndex;
  void offeredIndex;
}

/** {@link import('../catalystHooks.js').onDashPierceCatalyst} 의 power 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onResourceGrantedCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnResourceGranted(state: WorldState, amount: number, x: number, y: number): void {
  void state;
  void amount;
  void x;
  void y;
...
/** {@link import('../catalystHooks.js').onBossDeathCatalyst} 의 power 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLootRollCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnLootRoll(state: WorldState, x: number, y: number, elite: boolean): CatalystLootRoll {
  void state;
  void x;
  void y;
  void elite;
...
/** {@link import('../catalystHooks.js').onLootCollectedCatalyst} 의 power 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onWaveAdvancedCatalyst} 의 power 몫. **미배선**(위 §주석). */
export function powerOnWaveAdvanced(state: WorldState, prevSegment: number, nextSegment: number): void {
  void state;
  void prevSegment;
  void nextSegment;
}

/** {@link import('../catalystHooks.js').onEnemyContactCatalyst} 의 power 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyStepCatalyst} 의 power 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onDestructibleDestroyedCatalyst} 의 power 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').stepCatalystHazards} 의 power 몫. **미배선**(위 §주석). */
