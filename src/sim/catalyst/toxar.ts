...
/** {@link import('../catalystHooks.js').onEnemyDamagedCatalyst} 의 toxar 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyDeathCatalyst} 의 toxar 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onBossDeathCatalyst} 의 toxar 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onLootRollCatalyst} 의 toxar 몫. **미배선**(위 §주석). */
...
/** {@link import('../catalystHooks.js').onEnemyStepCatalyst} 의 toxar 몫. **미배선**(위 §주석). */
