...
export const EN = {
  ...
  'result.loot.debtRepaid': 'Debt Repaid',
  'result.loot.debtSeized': 'Loot Seized',
  'result.loot.debtSeizedVal': '{n} (unpaid debt)',
  'result.tip.power': 'Combat Power {n}',
  'result.drops.title': 'New Gear',
  'result.drops.none': 'No new gear this run.',
  'result.drops.pending': 'Receiving salvage…',
  ...
  'lab.all.hint': 'Click a row to read details · invest from the panel',
  'lab.detail.level': 'Invested {cur} / {max}',
  'lab.detail.scale': 'LEVEL SCALING',
  'lab.detail.now': 'AT Lv{lv} (current)',
  'lab.detail.ifOne': 'IF YOU INVEST 1pt (Lv{lv})',
  'lab.detail.atMax': 'AT Lv{lv} (max)',
  'lab.detail.lv1': 'WHAT THE FIRST POINT GIVES',
  'lab.detail.max': 'IF YOU MAX IT OUT',
  'lab.detail.btn.invest': 'Invest 1pt  ({n} left)',
  'lab.detail.btn.maxed': 'Maxed',
...
export const KO: Record<MessageKey, string> = {
  ...
  'result.loot.debtRepaid': '부채 상환',
  'result.loot.debtSeized': '전리품 압류',
  'result.loot.debtSeizedVal': '{n}점 (미상환 부채)',
  'result.tip.power': '전투력 {n}',
  'result.drops.title': '새 장비',
  'result.drops.none': '이번 런에는 새 장비가 없습니다.',
  'result.drops.pending': '전리품 수령 중…',
  ...
  'lab.all.hint': '행을 클릭하면 상세 · 투자는 오른쪽 패널에서',
  'lab.detail.level': '투자 {cur} / {max}',
  'lab.detail.scale': '레벨 스케일',
  'lab.detail.now': '현재 Lv{lv} 기준',
  'lab.detail.ifOne': '1pt 넣으면 (Lv{lv})',
  'lab.detail.atMax': '만렙 Lv{lv} 기준',
  'lab.detail.lv1': '첫 1포인트가 주는 것',
  'lab.detail.max': '20포인트를 다 넣으면',
  'lab.detail.btn.invest': '1pt 투자  (남은 {n})',
  'lab.detail.btn.maxed': '만렙',
  ...
  // ⚠️ 2026-08-08 사실 정정. 여기와 s2.b 는 "침략 단계가 높을수록 상위 등급"이라고 안내했지만
  //    서버(`issue_commission_for_run` 5단계)는 **단계와 무관한 순수 무작위**로 등급을 뽑는다 —
  //    화면이 없는 규칙을 설명하고 있었다. 발령 확률 30% 를 도입하면서 같은 축의 이 거짓도
  //    함께 고친다. 등급 분포(1급 55% / 2급 20% / 3급 18% / 4급 7%)는 숫자로 적지 않는다 —
  //    SQL 이 정본이고 UI 에 복제하면 세 번째 진실이 생긴다.
  'commission.about.getBody':
    '행성 보스를 처치하면 이따금 발급됩니다. 등급은 그때 무작위로 정해집니다.',
