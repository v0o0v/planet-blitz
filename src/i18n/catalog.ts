...
export const KO: Record<MessageKey, string> = {
  ...
  'def3.cmd.help.s5.b':
    '풍화는 배치해 둔 방어체에만 작용합니다. 보관함에 넣어 둔 방어체는 아무리 오래 두어도 닳지 않으므로 여분 방어체를 쌓아 두는 데에는 비용이 들지 않습니다. 다만 수호기만은 예외로, 한 번 닳은 정비도를 되돌릴 수 없습니다.',
