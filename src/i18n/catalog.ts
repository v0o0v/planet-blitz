...
export const KO: Record<MessageKey, string> = {
  ...
  'ctl.tgt.tail': '순위를 올리면 더 강한 상대가 여기에 제안된다.',
  ...
  'ctl.rev.none': '복수 창이 열린 상대가 없다. 기지가 함락되면 24시간 안에 되갚을 수 있다.',
  'ctl.rev.tail': '기지가 함락되면 그 상대가 24시간 동안 여기에 쌓인다.',
  'ctl.ops.head': '작전 상황',
  ...
  'def3.cmd.inv.more': '방어체는 설계도로 제작하거나 침공 방어 보상으로 얻는다.',
  'def3.cmd.inv.bpMore': '설계도는 침공을 막아 내면 나온다.',
