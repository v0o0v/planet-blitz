 ...
 * 0.02 는 `lifetime_granted = 1,000,000` 에서 천장이 {@link DAILY_BUDGET_DAY_30} 에 닿는다는
 * 뜻이다 — PvE 런 1회 per-call 상한이 5000/5000 이므로(`20260726000200` 헤더의 캡 정본)
 * **런 100회 규모**에서 최고점이 열린다. 접속만 하는 계정에는 영원히 열리지 않는다.
 */
export const DAILY_CEILING_RATE = 0.02;
