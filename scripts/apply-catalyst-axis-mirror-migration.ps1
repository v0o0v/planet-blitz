...
Write-Host "[NOTE] CAP_RESOURCE_MULT_MAX is still 2.2 in TWO places -"
Write-Host "       20260808060000 (this file, the clamp fn) and"
Write-Host "       20260807000000 (grant_currency_for's local constant)."
Write-Host "       Raise BOTH or the receipt is silently clamped. Target comes from"
Write-Host "       pnpm cap:sweep, re-run AFTER any catalogue re-tagging."
