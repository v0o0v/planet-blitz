# Planet Blitz - apply 20260727020000_invasion_band_restore.sql to the remote project.
#
# This single migration is SELF-CONTAINED: it rewrites all 20 NPC defense layouts,
# including the corrected boss assignment introduced by 20260727011000. Applying this
# one file alone lands the final state -- 20260727011000 does NOT need to be applied.
#
...
#   powershell -ExecutionPolicy Bypass -File scripts\apply-invasion-band-restore-migration.ps1
...
$name    = 'invasion_band_restore'
$file    = Join-Path $PSScriptRoot '..\supabase\migrations\20260727020000_invasion_band_restore.sql'
...
Write-Host ""
Write-Host "[DONE] invasion band restore is live on the remote seed bases."
Write-Host "       verify-invasion Edge Function was already redeployed (v35) from commit 573be9d."
