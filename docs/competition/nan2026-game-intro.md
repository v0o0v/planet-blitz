...
약불·중불·강불 중에 고르는데, **비용과 용해 위험과 수치 품질이 같이 움직입니다.** 강불은
좋은 수치가 나오는 대신 비용이 두 배로 들고 녹을 확률도 훨씬 높습니다.
...
기체의 레벨 상한은 100입니다. 100레벨이 되면 그 기체를 **퇴역**시킬 수 있는데, 이 선택이
이 게임에서 가장 큰 갈림길입니다.

**퇴역하면 무슨 일이 벌어지나**

퇴역한 기체는 사라지지 않고 **수호 기체가 되어 내 기지의 코어 방을 지킵니다.** 대신 치르는
대가가 분명합니다.

- 그때 **장착하고 있던 장비 여덟 칸이 그대로 봉인**됩니다. 창고로 돌아오지 않으니, 아끼는
  장비를 입힌 채 퇴역시킬지 벗겨 놓고 퇴역시킬지부터 정해야 합니다. 봉인된 장비의 성능이
  곧 그 수호기의 성능이 되므로, 좋은 것을 입혀 보낼수록 내 기지가 단단해집니다.
- 그 기체에 넣었던 **스킬 투자는 기체와 함께 동결**됩니다. 새 기체는 1레벨에서 다시 시작하며,
  포인트도 처음부터 모으게 됩니다.
- 창고에 넣어 둔 장비와 크레딧·광물은 건드리지 않습니다.

그 대가로 받는 것은 **계보 포인트 50점**과 새 기체입니다. **다음 기체는 7종 중 무엇이든
자유롭게 고를 수 있고**, 맨몸으로 시작하지 않도록 기본 장비를 한 벌 지급합니다. 퇴역은
강제가 아니라서, 100레벨인 채로 계속 그 기체를 몰아도 됩니다.

**수호 기체는 어떻게 싸우나**

수호기는 코어 방에서 침입자를 추적하며 사격합니다. 중요한 것은 **봉인된 주무기의 종류에
따라 싸우는 방식이 달라진다**는 점입니다. 벌컨을 입혀 보낸 수호기는 단발로 견제하고, 산탄은
부채꼴로 흩뿌리고, 레일건은 고속탄을, 미사일은 유도탄을, 빔은 이어지는 광선을 씁니다.
다만 관통이나 화염·냉기 같은 상태이상, 유니크 장비의 특수 효과까지 복제되지는 않습니다.

퇴역시킨 기체는 개수 제한 없이 쌓이지만, **실제로 코어 방에 세울 수 있는 것은 두 기**입니다.
방어 사령부에서 어느 수호기를 내보낼지 직접 고릅니다.

**수호기는 가만히 둬도 닳습니다**

이것이 이 시스템의 대가입니다. 수호기의 성능은 **매주 5%p씩 떨어지고, 50%가 바닥이며,
회복시킬 방법이 없습니다.** 배치해 두었든 창고에 재워 두었든 똑같이 닳습니다. 그래서
"한 번 강한 기체를 남겨 두면 영원히 안전한" 상태가 만들어지지 않고, 계속 새로운 세대를
길러 내보내야 합니다.

더 쓸모가 없어진 수호기는 **소멸**시킬 수 있습니다. 그러면 봉인돼 있던 장비가 창고로 돌아오고,
그 기체의 전투력에 남은 성능을 곱한 만큼 계보 포인트를 회수합니다. 즉 오래된 수호기는
버리는 것이 아니라 다음 세대의 밑천이 됩니다.
...
곡선입니다. **되돌릴 수 없습니다** — 한 가지에 넣은 포인트는 영영 그 가지에 남습니다. 화면에도
그렇게 경고해 둡니다.
...
난이도를 고를 수 없고 래더 순위는 그대로 유지되기 때문에**, 퇴역 직후 1레벨 기체로는 침공을
아예 할 수 없게 됩니다.

그래서 **퇴역시킨 기체를 다시 불러내 침공에 나갈 수 있게** 했습니다. 출격 화면에서 현역
기체 대신 예비역을 고르면, 그 기체가 봉인해 둔 장비와 스킬을 그대로 쓰고 나갑니다. 별도
비용은 없고, 다만 위에서 말한 성능 감쇠가 그대로 적용됩니다. 침공에서만 쓸 수 있습니다.

정리하면 이 게임의 엔드게임은 **"100레벨까지 키운 기체를 방어 전력으로 남기고, 그 값으로
다음 세대를 조금 더 유리하게 시작한다"** 는 순환입니다. 세대를 거듭할수록 코어 방이 두꺼워지고
계보가 쌓이지만, 성능 감쇠 때문에 손을 놓으면 그 자산이 서서히 줄어듭니다.
