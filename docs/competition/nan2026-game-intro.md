...
- **의뢰서** — 보스를 잡고 이긴 런 중 약 30%에서 발령됩니다. 계급이 4단계(정기·우선·특급·최종)
  있고, 여러 구간을 연속으로 조건을 지키며 돌파하는 형태입니다. 확정 보상이라 운에 기대지
  않고 재화를 모을 수 있는 창구입니다.
- **설계도** — 클리어 한 번당 3% 확률로 한 장 떨어집니다. 이것으로 기지 방어 유닛을 만듭니다.
  행성마다 나오는 설계도가 겹치지 않게 배정돼 있어서(카르곤은 화염·직격, 베르단은 물량·소환,
  니플헤임은 저지·보호, 아르케는 정밀·기계), **원하는 방어 유닛이 어느 행성에서 나오는지가
  행성 선택의 또 다른 이유**가 됩니다.
...
**방어 쪽도 놀지 않습니다.** 설계도로 만든 방어체는 편대 12종, 설비 17종, 기물 6종, 방어
보스 3종이 있고, 각각 레벨을 올리거나 중복 설계도로 승급시키거나 광물로 옵션을 다시 굴려
강화합니다. 승급하면 외형이 바뀌어서, 침공해 온 상대에게 보이는 과시 수단이 됩니다. 채우지
못한 슬롯은 기본 수비대가 자동으로 메워 주므로 빈칸이 그대로 뚫리지는 않습니다. 다만 방어
설비는 **매주 정비도가 5%p씩 떨어지고**, 0이 되면 성능이 절반까지 내려갑니다. 30일 넘게
접속하지 않으면 순위도 조금씩 내려갑니다. 방어는 한 번 짜 두고 끝나는 것이 아니라 관리
대상입니다.
