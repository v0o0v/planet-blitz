...
const GOLDEN: Readonly<Record<string, readonly string[]>> = {
  ...
  bubble: [
    'PO1@0', 'PO2@1', 'PO3@2', 'PO4@3', 'PO5@4', 'PO6@5', 'PO7@6', 'PO8@7', 'PO9@8', 'PO10@9',
    'DR1@10', 'DR2@11', 'DR3@12', 'DR4@13', 'DR5@14', 'DR6@15', 'DR7@16', 'DR8@17', 'DR9@18', 'DR10@19',
    'FI1@20', 'FI2@21', 'FI3@22', 'FI4@23', 'FI5@24', 'FI6@25', 'FI7@26', 'FI8@27', 'FI9@28', 'FI10@29',
  ],
  hatchling: [
    'BD1@0', 'BD2@1', 'BD3@2', 'BD4@3', 'BD5@4', 'BD6@5', 'BD7@6', 'BD8@7', 'BD9@8', 'BD10@9',
    'NU1@10', 'NU2@11', 'NU3@12', 'NU4@13', 'NU5@14', 'NU6@15', 'NU7@16', 'NU8@17', 'NU9@18', 'NU10@19',
    'SH1@20', 'SH2@21', 'SH3@22', 'SH4@23', 'SH5@24', 'SH6@25', 'SH7@26', 'SH8@27', 'SH9@28', 'SH10@29',
  ],
  mallow: [
    'SQ1@0', 'SQ2@1', 'SQ3@2', 'SQ4@3', 'SQ5@4', 'SQ6@5', 'SQ7@6', 'SQ8@7', 'SQ9@8', 'SQ10@9',
    'ME1@10', 'ME2@11', 'ME3@12', 'ME4@13', 'ME5@14', 'ME6@15', 'ME7@16', 'ME8@17', 'ME9@18',
    'ME10@19',
    'CU1@20', 'CU2@21', 'CU3@22', 'CU4@23', 'CU5@24', 'CU6@25', 'CU7@26', 'CU8@27', 'CU9@28', 'CU10@29',
  ],
  phantom: [
    'AS1@0', 'AS2@1', 'AS3@2', 'AS4@3', 'AS5@4', 'AS6@5', 'AS7@6', 'AS8@7', 'AS9@8', 'AS10@9',
  ...
  striker: [
    ...
    'S1@10', 'S2@11', 'S3@12', 'S4@13', 'S5@14', 'S6@15', 'S7@16', 'S8@17', 'S9@18', 'S10@19',
