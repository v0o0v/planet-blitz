...
const GOLDEN: Readonly<Record<string, readonly string[]>> = {
  ...
  phantom: [
    'AS1@0', 'AS2@1', 'AS3@2', 'AS4@3', 'AS5@4', 'AS8@7', 'AS9@8', 'AS10@9',
  ...
  striker: [
    ...
    'S1@10', 'S2@11', 'S3@12', 'S4@13', 'S5@14', 'S6@15', 'S7@16', 'S8@17', 'S10@19',
    'M1@20', 'M2@21', 'M3@22', 'M4@23', 'M5@24', 'M6@25', 'M7@26', 'M10@29',
  ],
};
